...
public class pike<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition pike = partdefinition.addOrReplaceChild("pike", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));
