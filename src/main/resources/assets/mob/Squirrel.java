...
public class squirrel<T extends Entity> extends EntityModel<T> {
	...
	public squirrel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(0, 21).addBox(-1.0F, 0.0F, -4.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -5.0F, -3.0F));
