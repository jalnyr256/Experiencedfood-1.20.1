...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> ONION_CROP = BLOCKS.register("onioncrop",
            () ->new Block(BlockBehaviour.Properties.copy(Blocks.POTATOES).noOcclusion().noCollission()));
