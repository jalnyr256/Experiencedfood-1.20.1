...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        trimmedArmorItem(ModItems.SQUIRREL_LEATHER_BOOTS);
        trimmedArmorItem(ModItems.SQUIRREL_LEATHER_CHESTPLATE);
        trimmedArmorItem(ModItems.SQUIRREL_LEATHER_HELMET);
        trimmedArmorItem(ModItems.SQUIRREL_LEATHER_LEGGINGS);
    }
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = ExperiencedFood.MOD_ID; // Change this to your mod id
