...
public enum ModArmorMaterials implements ArmorMaterial {
    SQUIRREL_LEATHER("squirrel_leather", 26, new int[]{5, 7, 5, 4}, 25, SoundEvents.ARMOR_EQUIP_LEATHER, 1f, 0f,
            () -> Ingredient.of(ModItems.SQUIRREL_LEATHER.get()));
    ...
    public String getName() {
        return ExperiencedFood.MOD_ID + ":" + this.name;
    }
