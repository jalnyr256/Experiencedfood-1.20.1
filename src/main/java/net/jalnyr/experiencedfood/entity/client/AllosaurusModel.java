...
public class AllosaurusModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animateWalk(ModAnimationDefenitions.ALLOWALK, limbSwing, limbSwingAmount, 8f, 1f);
        this.animate(((AllosaurusEntity) entity).idleAnimationState, ModAnimationDefenitions.ALLOIDLE, ageInTicks, 1f);
    }
